...
const options3d = ref<Model3d>({
  model: 'https://3d-project-waxpeer.netlify.app/Karambit.glb', //Ссылка на модельz
  ...
  sun: 'https://3d-project-waxpeer.netlify.app/qwantani.hdr',                                   //Ссылка на текстуру
})
</script>

<template>
  <div class="container">
    <Model3DViewer v-bind="options3d" />
  </div>
</template>
